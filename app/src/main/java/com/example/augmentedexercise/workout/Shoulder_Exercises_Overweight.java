...
public class Shoulder_Exercises_Overweight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeBtnBack2 = (ImageView) findViewById(R.id.seBtnBack2);

        SeJumpingJack = (CardView) findViewById(R.id.seJumpingJack2);
        SeSideArmRaises = (CardView) findViewById(R.id.seSideArmRaises2);
        SeArmRaises = (CardView) findViewById(R.id.seArmRaises2);
        SeKneePushup = (CardView) findViewById(R.id.seKneePushup2);
        SeDoubleHipTouch = (CardView) findViewById(R.id.seDoubleHipTouch2);
        SeJumpingJack2 = (CardView) findViewById(R.id.seJumpingJack_2);
        SeSideArmRaises2 = (CardView) findViewById(R.id.seSideArmRaises_2);
        SeArmRaises2 = (CardView) findViewById(R.id.seArmRaises_2);
        SeKneePushup2 = (CardView) findViewById(R.id.seKneePushup_2);
        SeDoubleHipTouch2 = (CardView) findViewById(R.id.seDoubleHipTouch_2);

        SeBtnBack2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Shoulder_Exercises_Overweight.this, BMI_Overweight.class);
