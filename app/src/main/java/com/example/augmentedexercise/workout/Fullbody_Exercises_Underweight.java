...
public class Fullbody_Exercises_Underweight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FbEBtnBack1 = (ImageView) findViewById(R.id.fbeBtnBack1);

        FbEJumpingJack = (CardView) findViewById(R.id.fbeJumpingJack1);
        FbEBurpees = (CardView) findViewById(R.id.fbeBurpees1);
        FbEHighKnees= (CardView) findViewById(R.id.fbeHighKnee1);
        FbEMountainClimbing = (CardView) findViewById(R.id.fbeMountainClimbing1);
        FbEArmRaises = (CardView) findViewById(R.id.fbeArmraises1);
        FbEStandingSideBend = (CardView) findViewById(R.id.fbeStandingSideBend1);
        FbEFlutterKick = (CardView) findViewById(R.id.fbeFlutterKickSquat1);
        FbEVsitBicycle = (CardView) findViewById(R.id.fbeVSitBicycle1);
        FbEWarriorPose = (CardView) findViewById(R.id.fbeWarriorPose1);
        FbESquatJack = (CardView) findViewById(R.id.fbeSquatJack1);

        FbEBtnBack1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Fullbody_Exercises_Underweight.this, BMI_Underweight.class);
                                        ...
                                        if (documentSnapshot.exists()){
                                            ...
                                            fStore.collection("fullbody_underweight").document(userID)
                                                    ...
                                                    .addOnFailureListener(e -> {
                                                        ...
                                                        Toast.makeText(Fullbody_Exercises_Underweight.this, "Error occured while adding data!", Toast.LENGTH_SHORT).show();
                                                    });
                                        }
                                        else{}
                                    }
