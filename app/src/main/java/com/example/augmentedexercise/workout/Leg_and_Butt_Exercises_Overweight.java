...
public class Leg_and_Butt_Exercises_Overweight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LbEBtnBack2 = (ImageView) findViewById(R.id.lbeBtnBack2);

        LbEJumpingJack = (CardView) findViewById(R.id.lbeJumpingJack2);
        LbESquat = (CardView) findViewById(R.id.lbeSquat2);
        LbEBackwardLunge = (CardView) findViewById(R.id.lbeBackwardLunge2);
        LbEWideArmPushup = (CardView) findViewById(R.id.lbeWideArmPushup2);
        LbESumoSquat = (CardView) findViewById(R.id.lbeSumoSquat2);
        LbEJumpingJack2 = (CardView) findViewById(R.id.lbeJumpingJack_2);
        LbESquat2 = (CardView) findViewById(R.id.lbeSquat_2);
        LbEBackwardLunge2 = (CardView) findViewById(R.id.lbeBackwardLunge_2);
        LbEWideArmPushup2 = (CardView) findViewById(R.id.lbeWideArmPushup_2);
        LbESumoSquat2 = (CardView) findViewById(R.id.lbeSumoSquat_2);

        LbEBtnBack2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Leg_and_Butt_Exercises_Overweight.this, BMI_Overweight.class);
