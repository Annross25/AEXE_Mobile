...
public class Leg_and_Butt_Exercises_Normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LbEBtnBack4 = (ImageView) findViewById(R.id.lbeBtnBack4);

        LbEJumpingJack = (CardView) findViewById(R.id.lbeJumpingJack4);
        LbESquat = (CardView) findViewById(R.id.lbeSquat4);
        LbEBackwardLunge = (CardView) findViewById(R.id.lbeBackwardLunge4);
        LbEWideArmPushup = (CardView) findViewById(R.id.lbeWideArmPushup4);
        LbESumoSquat = (CardView) findViewById(R.id.lbeSumoSquat4);
        LbEJumpingJack2 = (CardView) findViewById(R.id.lbeJumpingJack_4);
        LbESquat2 = (CardView) findViewById(R.id.lbeSquat_4);
        LbEBackwardLunge2 = (CardView) findViewById(R.id.lbeBackwardLunge_4);
        LbEWideArmPushup2 = (CardView) findViewById(R.id.lbeWideArmPushup_4);
        LbESumoSquat2 = (CardView) findViewById(R.id.lbeSumoSquat_4);

        LbEBtnBack4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Leg_and_Butt_Exercises_Normal.this, BMI_Normal.class);
