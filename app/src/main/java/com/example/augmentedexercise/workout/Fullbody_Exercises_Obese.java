...
public class Fullbody_Exercises_Obese extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FbEBtnBack3 = (ImageView) findViewById(R.id.fbeBtnBack3);

        FbEJumpingJack = (CardView) findViewById(R.id.fbeJumpingJack3);
        FbEBurpees = (CardView) findViewById(R.id.fbeBurpees3);
        FbEHighKnees= (CardView) findViewById(R.id.fbeHighKnee3);
        FbEMountainClimbing = (CardView) findViewById(R.id.fbeMountainClimbing3);
        FbEArmRaises = (CardView) findViewById(R.id.fbeArmRaises3);
        FbEStandingSideBend = (CardView) findViewById(R.id.fbeStandingSideBend3);
        FbEFlutterKick = (CardView) findViewById(R.id.fbeFlutterKickSquat3);
        FbEVsitBicycle = (CardView) findViewById(R.id.fbeVSitBicycle3);
        FbEWarriorPose = (CardView) findViewById(R.id.fbeWarriorPose3);
        FbESquatJack = (CardView) findViewById(R.id.fbeSquatJack3);

        FbEBtnBack3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Fullbody_Exercises_Obese.this, BMI_Obese.class);
