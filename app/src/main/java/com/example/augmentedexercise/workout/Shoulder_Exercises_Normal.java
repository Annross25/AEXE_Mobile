...
public class Shoulder_Exercises_Normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeBtnBack4 = (ImageView) findViewById(R.id.seBtnBack4);

        SeJumpingJack = (CardView) findViewById(R.id.seJumpingJack4);
        SeSideArmRaises = (CardView) findViewById(R.id.seSideArmRaises4);
        SeArmRaises = (CardView) findViewById(R.id.seArmRaises4);
        SeKneePushup = (CardView) findViewById(R.id.seKneePushup4);
        SeDoubleHipTouch = (CardView) findViewById(R.id.seDoubleHipTouch4);
        SeJumpingJack2 = (CardView) findViewById(R.id.seJumpingJack_4);
        SeSideArmRaises2 = (CardView) findViewById(R.id.seSideArmRaises_4);
        SeArmRaises2 = (CardView) findViewById(R.id.seArmRaises_4);
        SeKneePushup2 = (CardView) findViewById(R.id.seKneePushup_4);
        SeDoubleHipTouch2 = (CardView) findViewById(R.id.seDoubleHipTouch_4);

        SeBtnBack4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Shoulder_Exercises_Normal.this, BMI_Normal.class);
