...
public class Abs_Exercises_Normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AeBtnBack4 = (ImageView) findViewById(R.id.aebtnBack4);

        AePushup = (CardView) findViewById(R.id.aePushup4);
        AeBurpees = (CardView) findViewById(R.id.aeBurpees4);
        AeHighknee = (CardView) findViewById(R.id.aeHighKnee4);
        AeMountainClimbing = (CardView) findViewById(R.id.aeMountainClimbing4);
        AeStandingOpenGate = (CardView) findViewById(R.id.aeStandingOpenGate4);
        AeJumpingJack = (CardView) findViewById(R.id.aeJumpingJack4);
        AeFlutterKickSquat = (CardView) findViewById(R.id.aeFlutterKickSquat4);
        AeVsitBicycle = (CardView) findViewById(R.id.aeVSitBicycle4);
        AeCobraStretch = (CardView) findViewById(R.id.aeCobraStretch4);
        AeBackwardLunge = (CardView) findViewById(R.id.aeBackwardLunge4);

        AeBtnBack4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Abs_Exercises_Normal.this, BMI_Normal.class);
